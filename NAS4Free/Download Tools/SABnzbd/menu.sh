...
do
        ...
        case $choice in
            '1')	printf '\033\143'; echo -e "${inf} Installing..${nc}" ; echo " "
					. $scriptPath/"Download Tools"/SABnzbd/install.sh ;;
            '2') 	printf '\033\143'; echo -e "${inf} Running Update..${nc}" ; echo " "
                	. $scriptPath/"Download Tools"/SABnzbd/update.sh ;;
            #'3') 	printf '\033\143'; echo -e "${inf} Backup..${nc}" ; echo " "
            #    	. $scriptPath/"Download Tools"/SABnzbd/backup.sh ;;
			
			'a')	printf '\033\143'; . $scriptPath/"Download Tools"/SABnzbd/about.sh ;;
            'h')	printf '\033\143'; (. $scriptPath/gethelp.sh);;
            #'i')	printf '\033\143'; . $scriptPath/"Download Tools"/SABnzbd/moreinfo.sh ;;
