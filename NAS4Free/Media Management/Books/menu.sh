...
do
        ...
        echo " "
        echo -e "${ca}   1)${ca} Mylar (Comics)${nc}"
        echo -e "${ca}   2)${ca} LazyLibrarian${nc}"
        echo -e "${ca}   3)${ca} Calibre${nc}"
        echo " "
        ...
        case $choice in
			'1') 	echo -e "${inf} Taking you to the Mylar menu..${nc}" ; echo " "
                		. $scriptPath/"Media Management"/Books/Mylar/menu.sh ;;
			'2') 	echo -e "${inf} Taking you to the LazyLibrarian menu..${nc}" ; echo " "
                		. $scriptPath/"Media Management"/Books/LazyLibrarian/menu.sh ;;
			'3') 	echo -e "${inf} Taking you to the Calibre menu..${nc}" ; echo " "
                		. $scriptPath/"Media Management"/Books/Calibre/menu.sh ;;
