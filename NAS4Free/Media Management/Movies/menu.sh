...
do
        ...
        echo " "
        echo -e "${fin}   1)${msg} Radarr (Preferred)${nc}"
        echo -e "${ca}   2)${ca} CouchPotato${nc}"
        echo -e "${ca}   3)${ca} Watcher${nc}"
        echo " "
        ...
        case $choice in
			'1') 	echo -e "${inf} Taking you to the Radarr menu..${nc}" ; echo " "
                		. $scriptPath/"Media Management"/Movies/Radarr/menu.sh ;;
            '2') 	echo -e "${inf} Taking you to the CouchPotato menu..${nc}" ; echo " "
                		. $scriptPath/"Media Management"/Movies/Couchpotato/menu.sh ;;
			'3') 	echo -e "${inf} Taking you to the Watcher menu..${nc}" ; echo " "
                		. $scriptPath/"Media Management"/Movies/Watcher/menu.sh ;;
