...
do
        ...
        echo " "
        echo -e "${inf}  a) About Sickbeard${nc}"
        ...
        case $choice in
            '1')	printf '\033\143'; echo -e "${inf} Installing..${nc}" ; echo " "
                	. $scriptPath/"Media Management"/Sickbeard/install.sh ;;
            #'2')	printf '\033\143'; echo -e "${inf} Running Update..${nc}" ; echo " "
            #    	. $scriptPath/"Media Management"/Sickbeard/update.sh ;;
            #'3') 	printf '\033\143'; echo -e "${inf} Backup..${nc}" ; echo " "
            #    	. $scriptPath/"Media Management"/Sickbeard/backup.sh ;;

            'a')	printf '\033\143'; . $scriptPath/"Media Management"/Sickbeard/about.sh ;;
            'h')	printf '\033\143'; (. $scriptPath/gethelp.sh);;
            #'i')	printf '\033\143'; . $scriptPath/"Media Management"/Sickbeard/moreinfo.sh ;;
